...
class AttendanceController extends Controller
{
    ...
    protected $machine_attendance_repo;
    protected $machineAttendanceReportRepository;
    ...
    public function __construct(
        ...
        MachineAttendanceRepository $machine_attendance_repo,
        ...
        $this->machine_attendance_repo = $machine_attendance_repo;
        $this->machineAttendanceReportRepository = $machineAttendanceReportRepository;
    }
    ...
    public function index(Request $request)
    {
        ...
        $data['checkbox'] = true;
        $data['title'] = _trans('attendance.Attendance History sdas');
    ...
    public function machineAttendance(Request $request)
    {
        ...
        $data['departments'] = $this->departmentRepository->getAll();
        // dd($data);
        return view('backend.attendance.attendance.machine_attendance', compact('data'));
    }
