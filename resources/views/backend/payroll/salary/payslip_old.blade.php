    ...
    <div class="table-content table-basic">
            ...
            <div class="card-body">
                <div id="General-0">
                    ...
                    <div class="row mt-20">
                        ...
                        {{-- <div class="col-lg-6">
                            <h4>
                                {{ _trans('common.Basic Salary') }}  : {{ currency_format(@$data['salary']->employee->basic_salary) }}
                            </h4>
                        </div> --}}
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 d-flex">
                <div class="col-lg-6" style=" border-right: 1px dotted; margin-right: 15px; ">
                    <fieldset>
                        <legend>
                            <h3>
                                {{ _trans('payroll.Deduction') }}
                            </h3>
                            <hr>
                        </legend>
                        {{-- <div class="row mt-20">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                <p>
                                    {{ _trans('common.Absent Deduction') }}
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <p>
                                    :
                                    {{ currency_format(@$data['salary']->absent_amount) }}
                                </p>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                <p>
                                    {{ _trans('common.Late Deduction') }}
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <p>
                                    : {{ currency_format(@$data['salary']->late_deductions_amount) }}
                                </p>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                <p>
                                    {{ _trans('common.Half-Day Deduction') }}
                                </p>
                            </div>
                            <div class="col-lg-6">
                                <p>
                                    : {{ currency_format(@$data['salary']->half_day_deductions_amount) }}
                                </p>
                            </div>
                        </div>
                        <div class="row mt-4">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6">
                                <p>
                                    : {{ currency_format(@$data['salary']->employee->tax) }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row mt-20">
                            ...
                            <div class="col-lg-6">
                                <h4>
                                    :
                                    {{ currency_format($data['salary']->deduction_amount) }}
                                </h4>
                            </div>
                        </div>
