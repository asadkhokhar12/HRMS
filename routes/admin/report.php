...
Route::group(['prefix' => 'hrm', 'middleware' => ['xss', 'admin', 'MaintenanceMode', 'FeatureCheck:report']], function () {
    ...
    Route::group(['prefix' => 'report'], function () {
        ...
        Route::get('machine-attendance-history/{user}',                [AttendanceReportController::class, 'employeeMachineAttendanceHistory'])->name('machineEmployeeAttendance');
        ...
        Route::get('single-machine-attendance-list-data/{user}',       [AttendanceReportController::class, 'singleMachineReportDataTable'])->name('singleMachineAttendanceReport.dataTable');
        Route::post('single-machine-attendance-summary-report/{user}', [AttendanceReportController::class, 'singleMachineAttendanceSummaryReport'])->name('singleMachineAttendanceSummaryReport');
    });
    //report end
